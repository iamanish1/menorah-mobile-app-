...
**DISCOVERY OUTPUT COLLECTED — COLLISION REVIEW REQUIRED**; use the
...
| `MENORAH_RUNTIME_CANDIDATE_SHA` | `142b18a6e82843ad02c46e8cd61d9db3f1bfb3a2` | Must equal the executable checkout, scripts, images, manifests and release markers |
| `MENORAH_SERVER_STAGING_RUNTIME_SHA` | `142b18a6e82843ad02c46e8cd61d9db3f1bfb3a2` | Must equal `MENORAH_RUNTIME_CANDIDATE_SHA`; a later docs head is invalid here |

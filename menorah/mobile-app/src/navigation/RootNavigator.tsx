...
import MentalHealthCheckIn from '@/screens/assessment/mental-health-check-in';
...
export default function RootNavigator() {
  ...
  const linking: LinkingOptions<any> = {
    ...
    getStateFromPath: (path, options) => {
      ...
      if (state && firstRoute?.name === 'ResetPassword') {
      ...
      if (
        state
        && firstRoute?.name === 'ArticleDetail'
        && !isSafeNavigationIdentifier(
          (firstRoute.params as { slug?: unknown } | undefined)?.slug,
        )
      ) {
        return undefined;
      }
      ...
      >
        {!isAuthed ? (
          ...
          <>
            ...
            <Stack.Screen name="ArticleList" component={ArticleList} />
            <Stack.Screen name="ArticleDetail" component={ArticleDetail} />
            <Stack.Screen name="MentalHealthCheckIn" component={MentalHealthCheckIn} />

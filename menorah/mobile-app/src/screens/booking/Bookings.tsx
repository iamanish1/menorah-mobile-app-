...
const TRUST_ITEMS = [
  ...
  },
  {
    ...
    sub: "Connect with qualified counsellors",
  },
  {
    icon: Clock,
  ...
  const handleJoinSession = async (booking: Booking) => {
    ...
    try {
      if (booking.sessionType === "video") {
        ...
        const roomId =
          booking.chat?.roomId || (await resolveBookingChatRoomId(booking.id));
        navigation.navigate("ChatThread", { roomId });
      }
    } catch (error: any) {
      Alert.alert(
        "Cannot Open Session",
        error?.message || "Failed to join session. Please try again.",
      );
    }
  };
          ...
          <View style={{ paddingHorizontal: 20 }}>
            {displayBookings.map((booking) => (
              ...
              >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    >
                      {booking.specialization ||
                        "Counsellor will be assigned soon"}
                    </Text>
                  </View>
                  <View
                    style={{
                ...
                {/* Meta row */}
                <View
                  style={{ flexDirection: "row", gap: 16, marginBottom: 14 }}
                >
                  <View
                    style={{
                      flexDirection: "row",
              ...
              >
                ...
                <View
                  style={{
                    ...
                    borderRadius: 18,
                    backgroundColor:
                      scheme === "dark" ? colors.surface : "white",
                    borderWidth: 2,

...
- Reel videos use the same immutable managed-media namespace as images. The shared upload mount and `MEDIA_PUBLIC_BASE_URL` must expose a public HTTPS URL that Meta can retrieve.

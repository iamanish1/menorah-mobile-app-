    ...
    <div className="min-h-screen bg-menorah-page text-foreground">
      ...
      <main className="px-6 pb-16 pt-12 md:px-10 lg:px-20">
        <section className="mx-auto max-w-5xl text-center">
          ...
          <h1 className="mt-6 font-display text-4xl leading-tight tracking-[0.08em] md:text-5xl">FAQ&apos;S</h1>
        ...
        <section className="mx-auto mt-12 grid max-w-6xl gap-10 lg:grid-cols-[0.78fr_1.22fr]">
          <div className="lg:sticky lg:top-8 lg:self-start">
            <div className="overflow-hidden rounded-[2rem] border border-menorah-cream bg-background shadow-dashboard">
              <Image
                src="/what-we-do-vision.png"
                alt="Menorah support group illustration"
                width={600}
                height={600}
                priority
            ...
            <p className="mt-6 text-center font-brand text-sm uppercase tracking-[0.22em] text-menorah-olive">India</p>
          </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <summary className="flex cursor-pointer list-none items-start justify-between gap-5 text-left">
                  ...
                  <span className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-menorah-page font-semibold text-menorah-olive group-open:rotate-45">
                    +
                  </span>
                </summary>
                <p className="mt-4 text-[15px] leading-7 text-foreground/75">{faq.answer}</p>
              </details>
            ))}
          </div>
        </section>

        <section className="mx-auto mt-16 max-w-4xl rounded-[2rem] border border-menorah-cream bg-background px-6 py-10 text-center shadow-dashboard md:px-10">
          <h2 className="font-display text-3xl tracking-[0.08em]">Still have a question?</h2>

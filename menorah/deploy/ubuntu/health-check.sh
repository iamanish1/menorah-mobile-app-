...
assert_no_secret_leak() {
  ...
  local key value
  for key in JWT_SECRET JWT_REFRESH_SECRET MONGODB_URI MONGODB_BACKUP_URI REDIS_URL RAZORPAY_KEY_SECRET RAZORPAY_WEBHOOK_SECRET MSG91_AUTH_KEY LUXAND_API_TOKEN OPENAI_API_KEY CLOUDINARY_API_SECRET BACKUP_ENCRYPTION_PASSWORD; do
    value="${!key:-}"

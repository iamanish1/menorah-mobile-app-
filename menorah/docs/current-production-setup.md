...
- `CHECKOUT_RETURN_URL`
- `CHECKOUT_CALLBACK_SECRET` (an independent 32+ character secret for the HttpOnly Razorpay callback relay)
- `PUBLIC_API_ORIGIN`
- `LIVEKIT_URL`
- `LIVEKIT_API_URL`
- `LIVEKIT_API_KEY`
...
- `SOCIAL_STUDIO_VIDEO_UPLOAD_RATE_LIMIT`
- `SOCIAL_STUDIO_MAX_POSTS_PER_RUN`
- `SOCIAL_STUDIO_MAX_VIDEO_SIZE_MB`
- `SOCIAL_STUDIO_MAX_VIDEO_REQUEST_SIZE_MB`
- `SOCIAL_STUDIO_REEL_READY_ATTEMPTS`
- `SOCIAL_STUDIO_REEL_READY_INTERVAL_MS`
...
- `LIVEKIT_URL`
- `LIVEKIT_API_URL`
- `PUBLIC_API_ORIGIN` (the public `https://api-web.menorah.me` origin used for signed browser-call pages)
- `LIVEKIT_API_KEY`
- `LIVEKIT_API_SECRET`
- `LIVEKIT_UPSTREAM`
